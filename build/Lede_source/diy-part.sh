...
git clone https://github.com/kiddin9/openwrt-bypass/trunk/luci-app-bypass package/luci-app-bypass
git clone https://github.com/kiddin9/openwrt-bypass/trunk/lua-maxminddb package/lua-maxminddb
git clone https://github.com/kenzok8/small/trunk/kcptun package/kcptun
